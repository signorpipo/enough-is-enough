PP.EasyTuneEasyTransformWidget = class EasyTuneEasyTransformWidget {

    constructor(gamepad) {
        this._myGamepad = gamepad;

        this._mySetup = new PP.EasyTuneEasyTransformWidgetSetup();
        this._myUI = new PP.EasyTuneEasyTransformWidgetUI();
