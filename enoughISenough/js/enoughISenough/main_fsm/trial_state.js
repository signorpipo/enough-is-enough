class TrialState extends PP.State {
    constructor() {
        ...
        this._myFSM.addTransition("init", "first_talk", "start_2");
        ...
        this._myFSM.addTransition("first_vent", "second_defeat", "end");
        ...
        this._myFSM.addTransition("done", "first_talk", "start_2");
